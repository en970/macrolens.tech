          ...
          >
            ...
            <div className="flex flex-col items-center lg:items-start gap-4">
              <a
                ...
                className="h-14 px-6 rounded-xl bg-black text-white border border-white/15 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 group shadow-lg w-full sm:w-auto"
              >
                ...
                <div className="text-left leading-tight">
                  ...
                  <div className="text-lg font-semibold">{t.hero.ctaPlay}</div>
                </div>
              </a>
